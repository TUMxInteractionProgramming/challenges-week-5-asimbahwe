...
{
    $('#messages').empty();
    $('#channel-title h1').html('<div id="newc" style="display:flex;justify-content:space-between;"><input type="text" id="cname" placeholder="Enter a #ChannelName" style="width:80%;margin-bottom:15px;height:30px;">&nbsp;&nbsp;<span onclick="abortChannelCreation()" style="cursor:pointer;justify-self:flex-end;">x ABORT</span></div>');
    $('#sendBtn').html('CREATE');
